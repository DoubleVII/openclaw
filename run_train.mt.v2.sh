...
# data
TRAIN_FILES=$HOME/data/double7/training_data/towerx_v2_all_mt-code-block-think.verl/train.parquet
...
# Actor/Optimization
ACTOR_MODEL_PATH=$HOME/LLM/double7/qwen2.5-3b.sft.mt.v1
ACTOR_OPT_LR=1e-5
...
# Reward Model
REWARD_MODEL_PATH=$HOME/LLM/double7/qwen2.5-3b.verl.genrm.v2
...
EXPERIMENT_NAME=cot_mt_gspo.v2
N_GPUS_PER_NODE=8
...
RESUME_MODE=auto
TOTAL_EPOCHS=1
DEFAULT_LOCAL_DIR=$HOME/ckpt/double7/ckpt/Qwen/Qwen2.5-3B/verl/mt/unmerged/v2
